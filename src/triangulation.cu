...
public:
    ...
    // Constructor for .node and .ele files (without .neigh)
    ...
    // Constructor for synthetic mesh generation
    ...
    // Return the face index that contains edge e
    int index_face(int e) {
        return e / 3;
    }
    
    // Return the region of face f
